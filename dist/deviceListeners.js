...
(function () {
    'use strict';
    var temperatureListener = angular.module('opentele-commons.deviceListeners.temperature', [
        'opentele-commons.deviceListeners'
    ]);
    temperatureListener.service('temperatureListener', ["listenerConstants", "deviceListener", function (listenerConstants, deviceListener) {
        var handleMeasurementEvent = function (model, event) {
            var temperatureEvent = event;
            var temperature = temperatureEvent.value;
...
//# sourceMappingURL=temperatureListener.js.map
angular.module('opentele-commons.deviceListeners.templates', ['deviceListeners/measurementTemplates/bloodPressure.html', 'deviceListeners/measurementTemplates/saturation.html']);
