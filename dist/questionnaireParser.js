...
(function () {
    ...
    lungMonitorDeviceNodeParser.service('lungMonitorDeviceNodeParser', ["parserUtils", function (parserUtils) {
        var parseNode = function (node) {
...
(function () {
    'use strict';
    var temperatureDeviceNodeParser = angular.module('opentele-commons.questionnaireParser.temperatureDeviceNodeParser', [
        'opentele-commons.deviceListeners'
    ]);
    var temperatureDeviceNodeParserService = ["$templateCache", "parserUtils", "nativeService", "temperatureListener", function ($templateCache, parserUtils, nativeService, temperatureListener) {
        var OMIT = 'Omit';
        var NEXT = 'Next';
        var TEMPERATURE = 'temperature';
        var generateRepresentation = function (node, nodeModel) {
            var nodeTemplate = parserUtils.getNodeTemplate('temperatureDeviceNode.html');
            var leftButton = {
                text: OMIT,
                nextNodeId: node.nextFail
            };
            var rightButton = {
                ...
                nextNodeId: node.next,
                validate: function (scope) {
                    var isValueEntered = function () { return scope.nodeModel.temperature !== undefined; };
                    return isValueEntered();
                },
                clickAction: function (scope) {
                    var temperatureName = node.temperature.name;
                    var temperatureType = node.temperature.type;
                    var temperatureValue = scope.nodeModel.temperature;
        ...
        var parseNode = function (node, nodeMap, outputModel) {
            ...
            var eventListener = temperatureListener.create(nodeModel);
            nodeModel.eventListener = eventListener;
...
//# sourceMappingURL=temperatureDeviceNodeParser.js.map
(function () {
    'use strict';
...
angular.module('opentele-commons.questionnaireParser.templates', ['questionnaireParser/nodeTemplates/bloodPressureDeviceNode.html', 'questionnaireParser/nodeTemplates/bloodSugarManualDeviceNode.html', 'questionnaireParser/nodeTemplates/crpNode.html', 'questionnaireParser/nodeTemplates/delayNode.html', 'questionnaireParser/nodeTemplates/ioNodeEditText.html', 'questionnaireParser/nodeTemplates/ioNodeRadioButton.html', 'questionnaireParser/nodeTemplates/ioNodeText.html', 'questionnaireParser/nodeTemplates/saturationDeviceNode.html', 'questionnaireParser/nodeTemplates/saturationWithoutPulseDeviceNode.html', 'questionnaireParser/nodeTemplates/simpleInputNode.html', 'questionnaireParser/nodeTemplates/temperatureDeviceNode.html', 'questionnaireParser/nodeTemplates/temperatureManualDeviceNode.html', 'questionnaireParser/nodeTemplates/urineLevel.html', 'questionnaireParser/nodeTemplates/weightDeviceNode.html']);
...
angular.module("questionnaireParser/nodeTemplates/temperatureDeviceNode.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("questionnaireParser/nodeTemplates/temperatureDeviceNode.html",
    "<div class=\"center-div\">\n" +
    "    <h2 class=\"line-wrap\">{{ nodeModel.heading | translate }}</h2>\n" +
    "</div>\n" +
    "<div id=\"deviceHook\"></div>\n" +
    ...
    "    <fieldset class=\"questionnaire-fields\">\n" +
    "        <div class=\"block\">\n" +
    "            <label for=\"temperature-measurement\">{{ \"TEMPERATURE\" | translate }}</label>\n" +
    "            <input id=\"temperature-measurement\"\n" +
    "                   type=\"number\"\n" +
    "                   name=\"temperature-measurement\"\n" +
    "                   ng-model=\"nodeModel.temperature\"\n" +
    "                   disabled />\n" +
    "        </div>\n" +
    "        <div class=\"block\"\n" +
    "             ng-show=\"nodeModel.error !== undefined\">\n" +
    ...
    var service = ["$templateCache", "parserUtils", function ($templateCache, parserUtils) {
        var parseNode = function (node) {
            ...
            var rightButton = {
                ...
                validate: function (scope) { return scope.inputForm.$dirty; }
            };
            var representation = {
