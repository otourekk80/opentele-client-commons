(function() {
    ...
    describe('opentele-commons.questionnaireParser.haemoglobinDeviceNodeParser', function() {
        ...
        it('should parse node as simple input node', function() {
            ...
            expect(parserUtils.parseSimpleInputNode)
                .toHaveBeenCalledWith(node.HaemoglobinDeviceNode,
