(function() {
    ...
    describe('opentele-commons.questionnaireParser.urineDeviceNodeParser', function() {
        ...
        it('should parse node urine protein node', function() {
            ...
            expect(parsed.nodeModel.measurementSelections)
                .toEqual(['URINE_LEVEL_NEGATIVE', 'URINE_LEVEL_PLUS_MINUS',
