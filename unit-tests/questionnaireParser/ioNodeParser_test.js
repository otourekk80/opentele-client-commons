(function () {
    ...
    describe('opentele-commons.questionnaireParser.ioNodeParser', function () {
        ...
        describe('can parse IONode', function () {
            ...
            describe('Template replace', function () {
                ...
                it('should parse IONode with Integer EditTextElements', function () {
                    ...
                    expect(parsed.nodeTemplate).toMatch(/input_number_\d+.*/);
                    expect(parsed.nodeTemplate).toMatch(/form_input_number_\d+.*/);
                ...
                it('should parse IONode with String EditTextElements', function () {
                    ...
                    expect(parsed).toBeDefined();
                    expect(templateCache.get.mostRecentCall.args[0]).toMatch(/ioNodeEditText.html/);
                    expect(parsed.nodeTemplate).toMatch(/input_text_\d+.*/);
                    expect(parsed.nodeTemplate).toMatch(/form_input_text_\d+.*/);
        ...
        var runAndAssertValidationTest = function(parsed, fakeScope) {
            fakeScope.form_input_number_1349593812 = {
                input_number_1349593812: {
                    $valid: true
                }
            };
            fakeScope.form_input_text_2012267999 = {
                input_text_2012267999: {
                    $valid: false
                }
            };
            fakeScope.form_input_number_1858674478 = {
            ...
            fakeScope.form_input_number_1349593812.input_number_1349593812.$valid = false;
            fakeScope.form_input_text_2012267999.input_text_2012267999.$valid = true;
            expect(parsed.rightButton.validate(fakeScope)).toBe(false);

            fakeScope.form_input_number_1349593812.input_number_1349593812.$valid = false;
            fakeScope.form_input_text_2012267999.input_text_2012267999.$valid = false;
            expect(parsed.rightButton.validate(fakeScope)).toBe(false);

            fakeScope.form_input_number_1349593812.input_number_1349593812.$valid = true;
            fakeScope.form_input_text_2012267999.input_text_2012267999.$valid = true;
