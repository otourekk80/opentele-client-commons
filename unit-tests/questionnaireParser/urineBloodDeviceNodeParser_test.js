(function() {
    ...
    describe('opentele-commons.questionnaireParser.urineBloodDeviceNodeParser', function() {
        ...
        it('should parse node urine blood node', function() {
        ...
        it('should assign to output model when right button clicked', function () {
            ...
            expect(right.nextNodeId).toBe(node.BloodUrineDeviceNode.next);
            ...
            var output = scope.outputModel['110.URINE_BLOOD'];
        ...
        it('should have a cancel button setup', function () {
            ...
            expect(left.nextNodeId).toBe(node.BloodUrineDeviceNode.nextFail);
